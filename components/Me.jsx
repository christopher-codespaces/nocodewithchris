    ...
    <section className="py-10 bg-white sm:py-16 lg:py-24">
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="mx-auto text-left md:max-w-lg lg:max-w-2xl md:text-center">
          <h1 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight">
            ...
            <span className="relative inline-block">
              ...
              <span className="relative"> of how I am breaking into Tech </span>
            </span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-10">
          <div>
          <Image classNameName="w-full mx-auto" src={Bio} width={800} height={80} alt="" />
          </div>

          <div>
            <h1 className="text-lg font-semibold text-gray-900">Hey! I am Christopher Makombe, founder of Project Unplanned.</h1>
            <p className="mt-4 text-lg text-gray-700">{`Introducing Project Unplanned, my visionary creation spearheaded by my indomitable spirit. From the tender age of nine, my passion for technology ignited a journey that would shape my destiny.
            ...
            <p className="mt-4 text-lg text-gray-700">{`I embarked on a rollercoaster ride, founding and growing startups that challenged the status quo. Among these ventures, one soared to remarkable heights, boasting a pre-money valuation of a staggering 1.6 million. However, life's unpredictable twists and turns led me to close this chapter with profound lessons learned.
            ...
            <h3 className="mt-8 text-lg font-semibold text-gray-900">Unveiling the Trailblazer: My Odyssey to Innovation</h3>
            <p className="mt-4 text-lg text-gray-700">{`As you delve into my biography, you'll be enthralled by the unfolding drama of my life—the challenges that shaped me, the dreams that drive me, and the unwavering belief in the power of innovation.
